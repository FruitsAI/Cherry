...
// Reuse types or define subset needed
interface ConfigManagerProps {
  data: any; // We'll pass the full admin data here
}
  ...
  return (
    <div className="terminal-card border-[var(--cherry-green)]/30 p-6">
       ...
       <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            <IconDisplay icon="pixels/export.svg" imageClassName="w-5 h-5" /> 
            EXPORT DATABASE
          </button>
          ...
          >
            {isLoading ? (
                ...
                <>
                 <IconDisplay icon="pixels/import.svg" imageClassName="w-5 h-5" /> 
                 IMPORT / RESTORE
                </>
            )}
          </button>
