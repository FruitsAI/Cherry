 ...
 * Admin 页头组件
 *
 * @param props.version - 当前应用版本号
 */
export function AdminHeader({ version = "v0.0" }: { version?: string }) {
  return (
    <header className="border-b border-[var(--cherry-green)]/30 bg-[var(--cherry-bg-secondary)]/20 backdrop-blur-sm sticky top-0 z-50">
